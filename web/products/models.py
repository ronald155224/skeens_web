...
class Product(models.Model):
    ...
    name_en = models.CharField(_('Product Name En'), max_length=50, null=True, blank=True)
    description = models.TextField(_('Product Description'), max_length=500, null=True, blank=True)
    description_en = models.TextField(_('Product Description En'), max_length=500, null=True, blank=True)
